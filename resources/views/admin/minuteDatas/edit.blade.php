...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.minuteData.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.minute-datas.update", [$minuteData->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('year_created') ? 'is-invalid' : '' }}" type="text" name="year_created" id="year_created" value="{{ old('year_created', $minuteData->year_created) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('pdf_text') ? 'is-invalid' : '' }}" name="pdf_text" id="pdf_text">{{ old('pdf_text', $minuteData->pdf_text) }}</textarea>
