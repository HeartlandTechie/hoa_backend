    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.newsletters.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('newsletter_date') ? 'is-invalid' : '' }}" type="text" name="newsletter_date" id="newsletter_date" value="{{ old('newsletter_date') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('display_flag') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="display_flag" id="display_flag" value="1" {{ old('display_flag', 0) == 1 ? 'checked' : '' }}>
