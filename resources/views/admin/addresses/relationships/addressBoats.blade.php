    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-addressBoats">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($boats as $key => $boat)
                            <tr data-entry-id="{{ $boat->id }}">
                                ...
                                <td>
                                    @foreach($boat->addresses as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-addressBoats:not(.ajaxTable)').DataTable({ buttons: dtButtons })
